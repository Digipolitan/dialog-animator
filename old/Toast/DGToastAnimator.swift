...
open class DGToastAnimator {
	/**
	*	Struct used to maintain default values.
	*/
	...
	/**
	*	Struct that hold default pre-registered positions
	**/
	...
	/**
	*	Struct used to configure the behavior of the animator.
	*/
	...
	open static let `default`: DGToastAnimator = DGToastAnimator()
	private init() {}
	...
	func animate(view: UIView, in container: UIView?, with options: Options?, from initial: Position, to final: Position? = nil) {
	...
	func animate(view: UIView, in container: UIView?, with options: Options, initialPoint: CGPoint, finalPoint: CGPoint) {
